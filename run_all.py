...
SCRIPTS=[
 ...
 'src/frontier_reducer_v7.py','src/transfer_gap_v8.py','src/source_scaling_v8.py',
 'src/independent_verifier_v6.py','src/final_verifier_v6.py','src/build_master_verdict_v6.py',
 'src/final_verifier_v7.py','src/final_verifier_v8.py','src/make_figures.py'
]
for s in SCRIPTS:
