...
SCRIPTS=[
 ...
 'src/master_reducer_v6.py','src/atomic_reduction_v6.py','src/independent_verifier_v6.py','src/final_verifier_v6.py',
 'src/build_master_verdict_v6.py','src/make_figures.py'
]
for s in SCRIPTS:
