...
Assume B1–B3 and C1 together with the standard OS regularity bounds. Then the limiting Schwinger family satisfies the reconstruction hypotheses. The OS quotient is formed from positive-time test polynomials by
